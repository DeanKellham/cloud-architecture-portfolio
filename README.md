...
| **[IN-0002: Employing Cross-Account IAM Roles for User Console Access](./adrs/IN-0002-aws-iam-user-access[redacted].md)** | Security & Access | Implemented **IAM** and **STS** to reduce attack surface and blast radius while retaining required access for technicians to customer AWS Accounts. |
...
* **Security & Governance:** AWS Foundational Technical Reviews (FTR), IAM Least-Privilege, CloudTrail.
* **Infrastructure as Code (IaC) & Automation:** Functional scripting (PowerShell, Python, PHP, JS) for API integration.
